...
int main()
{
    heada = createadmin(heada,1,"Biryani",200);
    heada = createadmin(heada,2,"paneer Butter Masala",120);
    heada = createadmin(heada,3,"Veg Family Biryani",450);
    heada = createadmin(heada,4,"Egg Biryani",100);
    heada = createadmin(heada,5,"Cooldrinks",50);
    while(1)
    {
        mainnenu();
        int choice;
